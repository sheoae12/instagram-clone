        ...
        <div className={styles.feed_box}>
            <div className={styles.feed_top}>
                <div className={styles.feed_profile}>
                    <img className={styles.feed_profile_img} src='/story_profile_sample.png'/>
                </div>
                <div className={styles.feed_bold_text}>{username}</div>
                <div className={styles.feed_time}>• {createdAt}</div>
            </div>
            <div className={styles.feed_content}>
                <img className={styles.feed_img} src='/sample_img01.jpeg'/>
            </div>
                ...
                <div className={styles.feed_left_buttons}>
                    <div className={styles.feed_icon_box}>
                        <img 
                            ...
                            src='/assets/icon-notification-regular.svg'
                        />
                    </div>
                    <div className={styles.feed_icon_box}>
                        <img 
                            className={styles.feed_util_icon}
                            style={{marginRight: '10px'}} 
                            src='/assets/icon-reply-regular.svg'
                        />
                    </div>
                    <div className={styles.feed_icon_box}>
                        <img 
                            className={styles.feed_util_icon} 
                            style={{marginRight: '10px'}} 
                            src='/assets/icon-messenger-regular.svg'
                        />
                    </div>
                </div>
                <div className={styles.feed_icon_box}>
                    <img className={styles.feed_util_icon} src='/assets/icon-bookmark-regular.svg'/>
                </div>
            </div>
